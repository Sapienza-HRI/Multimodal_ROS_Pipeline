...
USE_BIAFFINE_LAYER: bool = False  # if true, the attention layer will be used
...
BATCH_SIZE: int = 8 #16 #64 #128  # 64 # 128
BATCH_SIZE_TEST: int = 8 # 32
BATCH_SIZE_VALID_TEST: int = 8 #16 #32
...
model_name: str = 'xlm-roberta-base' #'bert-base-multilingual-uncased' #'bert-base-cased'
...
if __name__ == '__main__':
    ...
    DEVICE: str = "cpu" #"cuda" if torch.cuda.is_available() and USE_GPU else "cpu"

    # Some path for the training phase
    DATASET_PATH: str = './data/IT_CANOPIES_multilingual_400.json' 
    DATASET_DEV_PATH: str = './data/it_CANOPIES_dev.json' 
